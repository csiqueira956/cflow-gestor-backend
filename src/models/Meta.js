...
class Meta {
  ...
  // Listar todas as metas (filtrado por company_id)
  static async list(company_id, filtros = {}) {
    let query = `
      SELECT
        m.*,
  ...
  // Buscar meta por ID (filtrado por company_id para segurança)
  ...
  // Atualizar meta (filtrado por company_id para segurança)
  static async update(id, metaData, company_id) {
    const {
      titulo,
      descricao,
      tipo,
  ...
  // Deletar meta (filtrado por company_id para segurança)
