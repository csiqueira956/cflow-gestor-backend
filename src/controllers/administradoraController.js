...
export const listarAdministradoras = async (req, res) => {
  try {
    ...
    const administradoras = await Administradora.list(company_id);
...
export const buscarAdministradora = async (req, res) => {
  try {
    const { id } = req.params;
    const { company_id } = req.user;
    const administradora = await Administradora.findById(id, company_id);
...
export const atualizarAdministradora = async (req, res) => {
  try {
    ...
    const administradoraExistente = await Administradora.findById(id, company_id);
...
export const deletarAdministradora = async (req, res) => {
  try {
    ...
    await Administradora.delete(id, company_id);
