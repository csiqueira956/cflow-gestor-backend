      ...
      {(provided, snapshot) => (
        ...
        >
          ...
          <button
            ...
            className="mt-3 w-full bg-primary-500 hover:bg-primary-600 text-white text-xs font-medium py-2 rounded transition-colors flex items-center justify-center gap-1"
